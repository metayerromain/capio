...
--
-- Host: localhost:8889
-- Generation Time: Feb 07, 2019 at 05:49 PM
...
INSERT INTO `content` (`id`, `title`, `description`, `slide`) VALUES
(0, '', 'Nous savons tous que lesloups tuent différentes espèces d’animaux mais nous sommes moins au courant qu’ils ont donné la vie à beaucoup d’autres ! ', ''),
...
(6, '', 'Les oiseaux migrateurs ont augmenté considérablement, le nombre de castors a aussi augmenté car ils aiment manger les arbres. Les castors ont utilisé les branchages pour la construction de barrages.', ''),
(7, '', 'Les castors ont utilisé les branchages pour la construction de barrages. Les castors, comme les loups sont des ingénieurs de l’écosystème, ils créent des niches pour d’autres espèces et les barrages qu’ils construisent dans les rivières fournissent des habitats pour les loutres, les ragondins, les canards, les poissons, les reptiles, les amphibiens.', ''),
(8, '', 'L’accroissement de la végétation a commencé à limiter l’érosion des sols et stabiliser les berges des rivières.', ''),
(9, '', 'Parce que les loups tuent les prédateurs des lapins et des souris, la population des rongeurs a augmenté. Un délice que n’a pas tardé à engloutir les aigles, les corbeaux, lynx, belettes, scarabées, et autres charognards.Les carcasses sont aussi bénéfiques pour les sols. Elles apportent des nutriments comme l’azote. ', ''),
(10, '', 'Les loups ont tué les coyottes, ce qui a entraîné une augmentation des lapins et de souris, l’apparition de faucons, de belettes, de renards et de blaireaux. Les aigles et les corbeaux se sont nourris des charognes laissé par les loups. Les castors ont également renforcé le travail des loups en tuant les bébés chevreuils.', ''),
(11, '', 'La population des ours a commencé à augmenter en raison de l’augmentation des baies sur les nouveaux arbustes. Les ours ont accentué la pression des loups en tuant quelques faons.', ''),
(12, '', 'Les loups ont changé le comportement des rivières. Elles ont commencé à moins zigzaguer grâce à la diminution de l’érosion. Les canaux se sont rétrécis, des mares se sont formées. Tout cela était parfait pour un habitat sauvage.', ''),
(13, 'Pourquoi?La forêt en pleine régénération a stabilisé les rivières qui se sont moins dégradées et du coup ont adopté un tracé plus figé dans le temps, les cerfs ont été repoussés des vallées et  rivières.', 'Conséquence de cette végétation qui a le temps de pousser : moins d’érosions. Du coup les loups, même peu nombreux ont non seulement transformé l’écosystème du Yellowstone mais également sa topographie. ', '');
