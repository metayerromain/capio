                    ...
                    <div className="row">
                        <div className="col-12 col-md-8 container">
                            <div className="blockText animText">
                                Parce que les loups tuent les prédateurs des <span data-id="0" className="lexique-word" onMouseEnter={ this.displayModal } onMouseLeave={ this.hideModal }>lapins </span> et des <span data-id="1" className="lexique-word" onMouseEnter={ this.displayModal } onMouseLeave={ this.hideModal }>souris </span>, la population des rongeurs a augmenté. Un délice que n’a pas tardé à engloutir les <span data-id="2" className="lexique-word" onMouseEnter={ this.displayModal } onMouseLeave={ this.hideModal }>aigles </span>, les <span data-id="3" className="lexique-word" onMouseEnter={ this.displayModal } onMouseLeave={ this.hideModal }>corbeaux </span>, <span data-id="4" className="lexique-word" onMouseEnter={ this.displayModal } onMouseLeave={ this.hideModal }>lynx </span>, <span data-id="5" className="lexique-word" onMouseEnter={ this.displayModal } onMouseLeave={ this.hideModal }>belettes </span>, <span data-id="6" className="lexique-word" onMouseEnter={ this.displayModal } onMouseLeave={ this.hideModal }>scarabées </span>, et autres charognards.Les carcasses sont aussi bénéfiques pour les sols. Elles apportent des nutriments comme l’azote.                             
                            </div>
                        </div>
                    </div>
                </div>
